...
export default function HomepageAbout() {
  return (
    <>
      <div className='absolute top-[831px] left-[calc(50%_-_640px)] bg-background-color w-[1280px] overflow-hidden flex flex-row items-center justify-end p-[100px] box-border gap-10 text-lg text-gray-gray-900'>
