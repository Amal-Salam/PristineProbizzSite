...
export default function HomepageServices() {
  return (
    <>
      <div className='absolute top-[1522px] left-[calc(50%_-_640px)] w-[1280px] overflow-hidden flex-col items-center justify-start p-[100px] box-border gap-14 text-5xl hidden lg:flex'>
      ...
      <div className='absolute top-[1544px] left-[calc(50%_-_180px)] w-[359px] overflow-hidden flex flex-col items-center justify-start p-4 box-border gap-6 text-5xl lg:hidden'>
        <div className='flex flex-col items-center justify-start gap-2 text-16xl'>
          <div className='relative leading-[55px] font-semibold'>{`Our Services `}</div>
          <div className='w-[69px] relative bg-brand-colors-secondary h-[5px]' />
        </div>
        <div className='self-stretch flex flex-col items-start justify-start gap-6'>
          <div className='self-stretch rounded-lg bg-black-colors-white border-brand-colors-primary border-[1px] border-solid flex flex-col items-start justify-start p-6 gap-4'>
            <div className='self-stretch flex flex-col items-start justify-start gap-[15px]'>
              <div className='w-[58px] relative rounded-981xl bg-black-colors-white border-brand-colors-primary border-[1px] border-solid box-border h-[58px] overflow-hidden shrink-0'>
                <img
                  className='absolute top-[calc(50%_-_17px)] left-[calc(50%_-_17px)] w-[34px] h-[34px] object-cover'
        ...
        <div className='self-stretch flex flex-col items-start justify-start gap-6'>
            ...
            <div className='self-stretch flex flex-col items-start justify-start gap-[15px]'>
              <div className='w-[58px] relative rounded-981xl bg-black-colors-white border-brand-colors-primary border-[1px] border-solid box-border h-[58px] overflow-hidden shrink-0'>
                <img
                  className='absolute top-[calc(50%_-_17px)] left-[calc(50%_-_17px)] w-[34px] h-[34px] object-cover'
                  alt=''
                  src='/code-perspective-matte2@2x.png'
                />
              </div>
              <div className='relative tracking-[-0.02em] leading-[30px] font-semibold'>
                Research support
          ...
          <div className='self-stretch flex flex-row items-center justify-center'>
            <div className='flex-1 rounded-lg bg-black-colors-white border-brand-colors-primary border-[1px] border-solid flex flex-col items-start justify-start p-6 gap-4'>
              <div className='self-stretch flex flex-col items-start justify-start gap-[15px]'>
                <div className='w-[58px] relative rounded-981xl bg-black-colors-white border-brand-colors-primary border-[1px] border-solid box-border h-[58px] overflow-hidden shrink-0'>
                  <img
                    className='absolute top-[calc(50%_-_17px)] left-[calc(50%_-_17px)] w-[34px] h-[34px] object-cover'
                    alt=''
                    src='/code-perspective-matte3@2x.png'
                  />
                </div>
                <div className='relative tracking-[-0.02em] leading-[30px] font-semibold'>
                  Trainings
