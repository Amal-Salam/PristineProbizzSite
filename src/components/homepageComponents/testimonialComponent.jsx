...
export default function HomepageTestimonials(){
  ...
  useEffect(() => {
    ...
    return (
      <>
        <div className='absolute top-[2516px] left-[calc(50%_-_640px)] bg-background-color w-[1280px] flex flex-col items-center justify-start p-[100px] box-border gap-14 text-center text-grey-colors-gray1'>
            ...
            <div className='w-[334px] flex flex-col items-center justify-start gap-2'>
              ...
              <div className='self-stretch flex flex-row items-center justify-center'>
                <div className='w-[334px] flex flex-col items-center justify-start gap-4'>
                  <div className='self-stretch flex flex-row items-center justify-center text-3xl'>
              ...
              <div className='flex flex-row items-start justify-start gap-6'>
                ...
                <div className='flex flex-row items-center justify-center'>
                  ...
                  <div
                    ...
                    className='self-stretch w-[488px] relative tracking-[-0.02em] leading-[38px] font-medium inline-block shrink-0'
                  >
