...
export default function HomepageBlog (){
    return (
      <>
        <div className='absolute top-[3266px] left-[calc(50%_-_640px)] w-[1280px] overflow-hidden flex-col items-center justify-center p-[100px] box-border gap-14 hidden lg:flex'>
        ...
        <div className='absolute top-[4214px] left-[calc(50%_-_180px)] w-[360px] h-[1864px] overflow-hidden flex flex-col items-center justify-center p-4 box-border gap-14 lg:hidden'>
          <div className='flex flex-col items-center justify-start gap-2'>
            <div className='relative leading-[55px] font-semibold'>
              Our Blog
            </div>
          ...
          <div className='self-stretch flex flex-row items-start justify-center flex-wrap content-start gap-[72px] text-base text-gray-gray-800'>
            {blogs.slice(0, 4).map((blog, index) => (
              <div key ={index} className='flex flex-col items-end justify-end gap-5'>
                <div className='flex flex-col items-start justify-start gap-5'>
                  <img
                    className='w-[254px] relative rounded-3xs h-[175px] object-cover'
                    alt=''
